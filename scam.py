...
def do():
  while True:
    ...
    nume = random.choice(numedefamilie)
    prenume_n = random.choice(prenume)

    username = nume + prenume_n
    username = username.lower()

    password = randomString()

    url = 'https://lucr.xyz/index/user/register/invite_code/ir7cw.html'
    ...
    print( "sent", random.choice(num), "to https://lucr.xyz/index/user/register/invite_code/ir7cw.html ")
